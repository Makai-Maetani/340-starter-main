...
-- Updates Client to Admin

UPDATE public.account
SET account_type = 'Admin'
WHERE account_email = 'tony@starkent.com';

-- Deletes the corresdponding email from that database

DELETE FROM public.account
WHERE account_email = 'tony@starkent.com';

-- Changes the Small interior to Big Interior For Gm Hummer

UPDATE public.inventory
SET inv_description = REPLACE(inv_description, 'small interiors', 'a huge interior')
WHERE inv_make = 'GM' AND inv_model = 'Hummer';

--Shows all cars with Sport reference
...
-- Gives Correct Path Names for cars and images
